...
function App() {
  ...
  useEffect(() => {
    ...
    if (dailyRecords.steps > 0 || hrFluctuations.length > 0) saveData();
        ...
        if (char?.value) {
          try {
            ...
            if (bpm > 30 && bpm < 220) { 
               ...
               // Record for new fluctuation section
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{padding: 20}}>
        ...
        {/* --- HR FLUCTUATIONS NOW AT THE TOP --- */}
        <Text style={styles.sectionTitle}>Heart Rate Fluctuations</Text>
        <View style={[styles.card, {borderLeftColor: '#6C5CE7', borderLeftWidth: 5}]}>
            <Text style={styles.label}>LIVE TREND (LOGGED BY TIME)</Text>
            ...
            <Text style={{color: '#888', fontStyle: 'italic', marginTop: 10}}>Connect band to see fluctuations...</Text>
            )}
        </View>

        {/* --- CALORIES AND DISTANCE (FIRST PAGE PRIMARY METRICS) --- */}
        ...
        <View style={[styles.card, {borderLeftColor: '#4285F4', borderLeftWidth: 5}]}>
          <Text style={styles.label}>GOOGLE FIT (PHONE)</Text>
          <Text style={styles.val}>{googleSteps.toLocaleString()}</Text>
        </View>

        {/* BAND DATA SECTION - ALWAYS VISIBLE TO SHOW LAST SYNCED DATA */}
        <View style={[styles.card, {borderLeftColor: '#00CEC9', borderLeftWidth: 5}]}>
            ...
            {connectedDevice && <Text style={styles.liveIndicator}>• Connected & Syncing</Text>}
        </View>
        ...
        <View style={styles.weeklyCard}>
            ...
            <View style={styles.weeklyItem}>
                ...
                <Text style={styles.weeklyVal}>{weeklyStats.calories}</Text>
            </View>
            <View style={styles.weeklyItem}>
                <Text style={styles.weeklyLabel}>Dist</Text>
                <Text style={styles.weeklyVal}>{weeklyStats.distance}km</Text>
            </View>
        </View>

        {/* DEVICE SCANNING LIST (Only shown if not connected) */}
        ...
        <View style={styles.historySection}>
          ...
          <View style={styles.historyRow}>
            ...
            <View style={styles.historyCard}>
              <Text style={styles.historyLabel}>Avg HR</Text>
...
const chartConfig = {
  ...
  color: (op = 1) => `rgba(108, 92, 231, ${op})`, labelColor: () => "#888",
  strokeWidth: 2,
};
