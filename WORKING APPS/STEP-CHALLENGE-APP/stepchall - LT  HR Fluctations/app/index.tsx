  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{padding: 20}}>
        ...
        {/* --- NEW SEPARATE WEEKLY CALCULATION SECTION --- */}
        <Text style={styles.sectionTitle}>Weekly Summary (7 Days)</Text>
        ...
        {connectedDevice ? (
          <>
            ...
            {/* --- ORIGINAL BAND HEART RATE CHART --- */}
            ...
            {/* --- NEW SEPARATE FLUCTUATIONS CHART WITH TIMESTAMPS --- */}
